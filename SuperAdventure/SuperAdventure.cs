...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            btnNorth.Visible = (newLocation.NorthLocation != null);
            btnEast.Visible = (newLocation.EastLocation != null);
            btnSouth.Visible = (newLocation.SouthLocation != null);
            btnWest.Visible = (newLocation.WestLocation != null);
            ...
            if (newLocation.QuestAvailable != null)
            {
                ...
                {
                    if (playerQuest.Details.ID == newLocation.QuestAvailable.ID)
                    {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        foreach (QuestCompletionItem qci in newLocation.QuestAvailable.QuestCompletedItems)
                        {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.Text += newLocation.QuestAvailable.RewardItem.Name + Environment.NewLine;
                            rtbMessages.Text += Environment.NewLine;

                            _player.ExperiencePoints += newLocation.QuestAvailable.RewardXP;
                            ...
                            foreach (PlayerQuest pq in _player.QuestList)
                            {
                ...
                else
                {
                    ...
                    _player.QuestList.Add(new PlayerQuest(newLocation.QuestAvailable));
                }
            }
