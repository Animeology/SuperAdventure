...
namespace Engine
{
    public static class World
    {
        ...
        static void PopulateMonsters()
        {
            ...
            Monster snake = new Monster(MONSTER_ID_SNAKE, 5, 3, "Snake", 10, 3, 3);
            ...
            Monster giantSpider = new Monster(MONSTER_ID_GIANT_SPIDER,  20, 5, "Giant spider", 40, 10, 10);
        ...
        static void PopulateQuests()
        {
            ...
            clearAlchemistGarden.QuestCompletedItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_RAT_TAIL), 3));
            ...
            clearFarmersField.QuestCompletedItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_SNAKE_FANG), 3));
        ...
        static void PopulateLocations()
        {
            ...
            home.NorthLocation = townSquare;

            townSquare.NorthLocation = alchemistHut;
            townSquare.SouthLocation = home;
            townSquare.EastLocation = guardPost;
            townSquare.WestLocation = farmhouse;

            farmhouse.EastLocation = townSquare;
            farmhouse.WestLocation = farmersField;

            farmersField.EastLocation = farmhouse;

            alchemistHut.SouthLocation = townSquare;
            alchemistHut.NorthLocation = alchemistsGarden;

            alchemistsGarden.SouthLocation = alchemistHut;

            guardPost.EastLocation = bridge;
            guardPost.WestLocation = townSquare;

            bridge.WestLocation = guardPost;
            bridge.EastLocation = spiderField;

            spiderField.WestLocation = bridge;
